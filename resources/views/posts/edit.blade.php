    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-10 mx-auto shadow">
                <form action="{{route('posts.update',$post)}}" method="POST" class="form-group">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="content" class="form-label">
                            <textarea name="content" id="content"  row="2" column="2" class="form-control">{{$post->content}}</textarea>
                        </label>
                    </div>
                    <div class="mb-3">
